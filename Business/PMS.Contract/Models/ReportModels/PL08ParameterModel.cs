...
{
    public class PL08ParameterModel : PagingParameterModel
    {
        ...
        /// <summary>
        /// Tài khoản AD Bác Sĩ chỉ định
        /// </summary>
        [RegularExpression(@"^(?=[A-Za-z0-9])(?!.*[._\[\]-]{2})[A-Za-z0-9._\[\]-]{3,50}$", ErrorMessage = "AdDoctorCharge is invalid!")]
        public string AdDoctorCharge { get; set; }
        /// <summary>
        /// Tài khoản AD Bác Sĩ thực hiện
        /// </summary>
        [RegularExpression(@"^(?=[A-Za-z0-9])(?!.*[._\[\]-]{2})[A-Za-z0-9._\[\]-]{3,50}$", ErrorMessage = "AdDoctorOperation is invalid!")]
        public string AdDoctorOperation { get; set; }
        /// <summary>
        /// Mã nhóm dịch vụ
        /// </summary>
