    ...
    public class DragPanel : Panel
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                ...
                ScriptProxy.LoadControlScript(this, jQueryScriptLocation, WebConsts.JQUERY_SCRIPT_RESOURCE, ScriptRenderModes.HeaderTop);
                ScriptProxy.LoadControlScript(this, ScriptLocation, WebConsts.WWJQUERY_SCRIPT_RESOURCE, ScriptRenderModes.Header);
            }
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (Closable && !string.IsNullOrEmpty(DragHandleID))
            {
                ...
                if (imageUrl == "WebResource")
                    imageUrl = ScriptProxy.GetWebResourceUrl(this, GetType(), WebConsts.CLOSE_ICON_RESOURCE);
            ...
            if (Draggable)
            {
                ...
                options = "{  stack: {group: \"*\", min:50}, opacity: 0.80, dragDelay: " + DragDelay.ToString();
