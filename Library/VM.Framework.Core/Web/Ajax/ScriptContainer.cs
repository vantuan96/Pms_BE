...
namespace GAPIT.MKT.Framework.Core
{
    ...
    public class ScriptContainer : Control
    {
        ...
        public static ScriptContainer Current
        {
            get
            {
                ...
                if (page == null)
                    throw new InvalidOperationException("wwScriptContainer.Current only works with Page based handlers.");
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Page.Items.Contains(STR_CONTEXTID))
                throw new InvalidOperationException("Only one ScriptContainer is allowed per page.");
    ...
    public class ScriptItem
    {
        ...
        /// calendar
        /// </summary>
        [Description("Specifies a known resource: wwScriptLibrary, jQuery, Calendar")]
        [Category("Script"), DefaultValue(typeof(ScriptRenderModes), "InheritFromControl")]
