...
namespace GAPIT.MKT.Framework.Core
{
    ...
    public class WebUtils
    {
                                               ...
                                               object data)
        {
            ...
            Html = StringHelper.ExtractString(Html, STR_BeginRenderControlBlock, STR_EndRenderControlBlock);
        ...
        {
            string res = StringHelper.ExtractString("&" + urlEncodedString, "&" + key + "=", "&", false, true);
